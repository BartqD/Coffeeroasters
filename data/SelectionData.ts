export const SelectionData = {
	...
	grind: [
		...
		{ title: 'Cafetiére', description: 'Course ground beans specially suited for french press coffee' },
	],
	deliver: [
		{ title: 'Every week', description: '$7.20 per shipment. Includes free first-class shipping.' },
		{ title: 'Every 2 weeks', description: '$9.60 per shipment. Includes free priority shipping.' },
		{ title: 'Every month', description: '$12.00 per shipment. Includes free priority shipping.' },
	],
}

export const SelectionHeading = {
	preferences: ['How do you drink your coffee?'],
	coffeeType: ['What type of coffee?'],
	quantity: ['How much would you like?'],
	grind: ['Want us to grind them?'],
	deliver: ['How often should we deliver?'],
}
